"""
LangChain Documentation FastAPI Server Entry Point (No MCP)

This module provides a FastAPI application that serves real LangChain API reference and documentation
using the shared LangChainDocumentationService without MCP integration for now.
"""
...
app = FastAPI(
    title="LangChain Documentation Server",
